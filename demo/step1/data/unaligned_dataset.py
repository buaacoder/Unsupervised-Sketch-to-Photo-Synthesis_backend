...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_B = os.path.join('./datasets/shoes/testB')  # create a path '/path/to/data/trainB'
        self.dir_noise = os.path.join('./datasets/shoes/test_noise')  # create a path '/path/to/data/trainB'
